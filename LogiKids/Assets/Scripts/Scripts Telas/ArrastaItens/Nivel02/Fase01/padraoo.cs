...
public class padraoo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        locked = true;
        Confirma02_01.Posicao01 = "";
        Confirma02_01.Posicao02 = "";
        Confirma02_01.Posicao03 = "";
    }
    ...
    private void Update()
    {
        ...
        if ((Input.GetMouseButtonUp(0)) && (locked == false))
        {
            ...
            if (dif01x <= 0.8f && dif01y <= 0.8f && Confirma02_01.Posicao01 == "")
            {
                transform.position = new Vector2(place1.position.x, place1.position.y);
                locked = true;
                Confirma02_01.Posicao01 = NomeObj;
            }
            else if (dif02x <= 0.8f && dif02y <= 0.8f && Confirma02_01.Posicao02 == "")
            {
                transform.position = new Vector2(place2.position.x, place2.position.y);
                locked = true;
                Confirma02_01.Posicao02 = NomeObj;
            }
            else if (dif03x <= 0.8f && dif03y <= 0.8f && Confirma02_01.Posicao03 == "")
            {
                transform.position = new Vector2(place3.position.x, place3.position.y);
                locked = true;
                Confirma02_01.Posicao03 = NomeObj;
            }
            else
            {
                transform.position = new Vector2(initialPosition.x, initialPosition.y);
                locked = true;
                if (Confirma02_01.Posicao01 == NomeObj)
                {
                    Confirma02_01.Posicao01 = "";
                }
                else if (Confirma02_01.Posicao02 == NomeObj)
                {
                    Confirma02_01.Posicao02 = "";
                }
                else if (Confirma02_01.Posicao03 == NomeObj)
                {
                    Confirma02_01.Posicao03 = "";
                }
            }
