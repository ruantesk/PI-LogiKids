...
public class padrao02_03 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        locked = true;
        Confirma02_03.Posicao01 = "";
        Confirma02_03.Posicao02 = "";
        Confirma02_03.Posicao03 = "";
    }
    ...
    private void Update()
    {
        ...
        if ((Input.GetMouseButtonUp(0)) && (locked == false))
        {
            ...
            if (dif01x <= 0.5f && dif01y <= 0.5f && Confirma02_03.Posicao01 == "")
            {
                transform.position = new Vector2(place1.position.x, place1.position.y);
                locked = true;
                Confirma02_03.Posicao01 = NomeObj;
            }
            else if (dif02x <= 0.5f && dif02y <= 0.5f && Confirma02_03.Posicao02 == "")
            {
                transform.position = new Vector2(place2.position.x, place2.position.y);
                locked = true;
                Confirma02_03.Posicao02 = NomeObj;
            }
            else if (dif03x <= 0.5f && dif03y <= 0.5f && Confirma02_03.Posicao03 == "")
            {
                transform.position = new Vector2(place3.position.x, place3.position.y);
                locked = true;
                Confirma02_03.Posicao03 = NomeObj;
            }
            else
            {
                transform.position = new Vector2(initialPosition.x, initialPosition.y);
                locked = true;
                if (Confirma02_03.Posicao01 == NomeObj)
                {
                    Confirma02_03.Posicao01 = "";
                }
                else if (Confirma02_03.Posicao02 == NomeObj)
                {
                    Confirma02_03.Posicao02 = "";
                }
                else if (Confirma02_03.Posicao03 == NomeObj)
                {
                    Confirma02_03.Posicao03 = "";
                }
            }
