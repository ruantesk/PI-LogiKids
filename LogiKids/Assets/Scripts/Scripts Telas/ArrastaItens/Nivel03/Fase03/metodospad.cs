...
public class metodospad : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Confirma03_03.Metodo01 = "";
        Confirma03_03.Metodo02 = "";
        Confirma03_03.Metodo03 = "";
    }
    ...
    private void Update()
    {
        ...
        if ((Input.GetMouseButtonUp(0)) && (locked == false) && lockedDef == false)
        {
            ...
            if ((dif01x <= 0.5f) && (dif01y <= 0.5f) && (Confirma03_03.Metodo01 == ""))
            {
                transform.position = new Vector2(place1.position.x, place1.position.y);
                locked = true;
                Confirma03_03.Metodo01 = NomeObj;
            }
            else if ((dif02x <= 0.5f) && (dif02y <= 0.5f) && (Confirma03_03.Metodo02 == ""))
            {
                transform.position = new Vector2(place2.position.x, place2.position.y);
                locked = true;
                Confirma03_03.Metodo02 = NomeObj;
            }
            else if ((dif03x <= 0.5f) && (dif03y <= 0.5f) && (Confirma03_03.Metodo03 == ""))
            {
                transform.position = new Vector2(place3.position.x, place3.position.y);
                locked = true;
                Confirma03_03.Metodo03 = NomeObj;
            }
            else
            {
                transform.position = new Vector2(initialPosition.x, initialPosition.y);

                if (Confirma03_03.Metodo01 == NomeObj)
                {
                    Confirma03_03.Metodo01 = "";
                }
                else if (Confirma03_03.Metodo02 == NomeObj)
                {
                    Confirma03_03.Metodo02 = "";
                }
                else if (Confirma03_03.Metodo03 == NomeObj)
                {
                    Confirma03_03.Metodo03 = "";
                }
            }
